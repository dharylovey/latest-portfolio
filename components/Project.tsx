...
const Project = () => {
  return (
    <section
      id="project"
      className="min-h-screen flex flex-col items-center justify-center text-center gap-16"
    >
      <div className="text-center">
        <h3 className="text-5xl font-bold">Project</h3>
      </div>
      <div className="w-1/2 block my-4 font-sans text-xl antialiased leading-relaxed text-gray-500 dark:text-white">
